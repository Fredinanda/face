		...
		<div id="wrapper">
			...
			<div id="content">
				...
				<div id="textbox">
					...
					<textarea rows="6"
						style="line-height: 1; font-size: 120%; width: 100%;">¹«½¼ »ý°¢À» ÇÏ°í °è½Å°¡¿ä?</textarea>
					<script type='text/javascript'>
						$(function() {
							$('textarea').autogrow();
						});
		...
		<div id="extra">
			<p>
				...
				<br> <img src="/mysite3/assets/images/Facebook.png"
					...
					src="/mysite3/assets/images/mes.png" style="padding-right: 10px">¸Þ¼¼Áö<br>
